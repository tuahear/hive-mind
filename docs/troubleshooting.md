...
3. Run `~/.claude/hive-mind/core/sync.sh` (or just open Claude Code in the project — the Stop hook regenerates the sidecar with the new URL and pushes it). Do this on every machine that has the project.
